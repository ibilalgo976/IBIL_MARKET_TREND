...
df1['macd'], df1['macdSignal'], df1['macdHist'] = talib.MACD(df1['Close'], fastperiod=MACD_FAST, slowperiod=MACD_SLOW, signalperiod=MACD_SIGNAL)
...
df['WILLR3'] = talib.WILLR(df['High'], df['Low'], df['Close'], timeperiod=3)
df['WILLR10'] = talib.WILLR(df['High'], df['Low'], df['Close'], timeperiod=10)
df['WILLR30'] = talib.WILLR(df['High'], df['Low'], df['Close'], timeperiod=30)
df['WILLR90'] = talib.WILLR(df['High'], df['Low'], df['Close'], timeperiod=90)
df['WILLR270'] = talib.WILLR(df['High'], df['Low'], df['Close'], timeperiod=270)
...
df['BB3100Z1UP'], df['BB100Z1MID'], df['BB100Z1LO'] = talib.BBANDS(df['MKT VOLATILTY Signal'], timeperiod=100, nbdevup=1, nbdevdn=1, matype=0)
